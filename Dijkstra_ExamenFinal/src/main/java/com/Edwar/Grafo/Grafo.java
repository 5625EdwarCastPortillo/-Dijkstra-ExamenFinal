...
public class Grafo {
    ...
    int tamanioLetra = 0; //Sirve para medir el tamanio de la ruta
    char[] nodos;  // Letras de identificación de nodo de los municipios
    ...
    public String encontrarRutaMinimaDijkstra(char inicio, char fin) {
        ...
        guardar = funcion.IdentificadorMunicipio(ruta, tamanio);

        tamanioLetra = tamanio;

        return "Distancia Total para LLegar el Destino: " + distancia + "Km: " + guardar;
    }

    public int TamanioFont() {
        return tamanioLetra;
    }
